export const questions = [
  {
    ...
    answer:
      "careero is a comprehensive job platform designed to bridge the gap between job seekers and employers.",
  },
  ...
  /* {
        id:10,
        question:'Do I need to create an account to use careero?',
